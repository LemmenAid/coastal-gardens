...
class BlogViewTests(TestCase):
    ...
    def test_edit_comment(self):
        ...
        comment = Comment.objects.create(
            post=self.post, author=self.user, body="Original content")
        response = self.client.post(
            reverse("comment_edit", kwargs={
                    "slug": self.post.slug, "comment_id": comment.id}),
            {"body": "Edited content"},
        )
    ...
    def test_delete_comment(self):
        ...
        comment = Comment.objects.create(
            post=self.post, author=self.user, body="To be deleted")
        response = self.client.post(
            reverse("comment_delete", kwargs={
                "slug": self.post.slug, "comment_id": comment.id})
        )
